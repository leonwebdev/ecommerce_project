...
CREATE TABLE `advertisement` (
  ...
  `pages` enum('all','home','product-list') DEFAULT NULL,
  `area` enum('top','bottom','sidebar') DEFAULT NULL,
...
CREATE TABLE `product` (
  ...
  KEY `product_ibfk_2` (`size_id`),
  CONSTRAINT `product_ibfk_2` FOREIGN KEY (`size_id`) REFERENCES `size` (`id`),
  CONSTRAINT `product_variant_ibfk_1` FOREIGN KEY (`gender_id`) REFERENCES `gender` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-07-18 14:46:23
